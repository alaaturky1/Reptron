...
#ifndef SUPPLEMENTSTORE_SWIFT_H
#define SUPPLEMENTSTORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SupplementStore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15SupplementStore31WorkoutAnalysisSampleBufferSink")
@interface WorkoutAnalysisSampleBufferSink : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate>
