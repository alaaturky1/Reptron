...
fun CoachDetailsView(
    ...
    Column(
        ...
        Box(
            ...
            Text(coach.name, color = Color.White, fontSize = 20.sp)
        }
        ...
        Column(
            ...
            Row(
                ...
                StatItem("Experience", coach.experience, modifier = Modifier.weight(1f))
                StatItem("Clients", coach.clients, modifier = Modifier.weight(1f))
                StatItem("Certifications", coach.certifications, modifier = Modifier.weight(1f))
            }
            ...
            Card(
                ...
                Column(
                    ...
                    coach.hourlyRate?.let { rate ->
                        InfoRow(Icons.Default.AttachMoney, rate)
                    }
                }
            }

            Button(
                onClick = { onNavigate(AppRoute.CoachesProfiles(coach.id)) },
                modifier = Modifier.fillMaxWidth(),
